...
\NormalTok{knitr}\SpecialCharTok{::}\FunctionTok{kable}\NormalTok{(sum.m1}\SpecialCharTok{$}\NormalTok{coefs.SE.CI[, }\DecValTok{1}\SpecialCharTok{:}\DecValTok{4}\NormalTok{])}
\end{Highlighting}
\end{Shaded}
